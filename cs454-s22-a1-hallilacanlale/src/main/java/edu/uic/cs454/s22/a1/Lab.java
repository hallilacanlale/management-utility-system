...
import edu.uic.cs454.s22.a1.solution.SolutionDiagTest;
import edu.uic.cs454.s22.a1.solution.SolutionLab;
import edu.uic.cs454.s22.a1.solution.SolutionTestingSite;

import java.util.*;

public abstract class Lab<TS extends TestingSite, DT extends DiagnosticTest> {
//    public static Map<SolutionDiagTest, Integer> tests = new HashMap<>();
